...
class SrWganGp(train.AbsTrainer):
    ...
    def train_step_dis(self, lr_batch, hr_batch):
        with tf.GradientTape() as tape:
            ...
            w_loss = d_loss_fake - d_loss_real # + 0.00005*gp
            d_loss = w_loss  + self.gp_wight*gp
